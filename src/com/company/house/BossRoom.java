...
public class BossRoom {
    ...
    public void intro(){
        ...
        System.out.println(player.getName() + ": The person responsible for looking me in this mad house?");
        System.out.println("<< Yes, but...>>");
        System.out.println(player.getName() + ": But...nothing. I want out and defeating them is house I get out.");
        System.out.println("<< ??? >>");
        System.out.println(player.getName() + ": At least wish me luck.");
